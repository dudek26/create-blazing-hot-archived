...
public class BlazingItems {
    ...
    public static final ItemEntry<Item>
            ...
            BLAZE_GOLD_NUGGET =
                    taggedIngredient("blaze_gold_nugget", BlazingTags.commonItemTag("blaze_gold_nuggets")),
            BLAZE_GOLD_SHEET =
    ...
    public static final ItemEntry<Item>
            ...
            STONE_DUST =
                    taggedIngredient("stone_dust", BlazingTags.commonItemTag("stone_dusts")),
            SOUL_DUST =
    ...
    public static final ItemEntry<ExtinguishingItem>
            BLAZE_CARROT =
            REGISTRATE
                    ...
                    .onRegisterAfter(Registries.ITEM,
                                     v -> ItemDescription.useKey(v, "item.blazinghot.extinguishing_food"))
                    .tag(BlazingTags.Items.FOODS.tag)
                    .register();
    ...
    public static final ItemEntry<Item>
            ...
            REGISTRATE
                    ...
                    .properties(
                            p -> p.food(Foods.STELLAR_GOLDEN_APPLE.foodProperties).rarity(Rarity.RARE).fireResistant())
    ...
    public static final ItemEntry<ExtinguishingItem>
            ...
            REGISTRATE
                    ...
                    .tag(BlazingTags.Items.FOODS.tag)
                    .properties(
                            p -> p.food(Foods.STELLAR_BLAZE_APPLE.foodProperties).rarity(Rarity.RARE).fireResistant())
                    .onRegisterAfter(Registries.ITEM,
                                     v -> ItemDescription.useKey(v, "item.blazinghot.extinguishing_food"))
                    .register();
    ...
    public static final ItemEntry<ExtinguishingItem>
            ...
            REGISTRATE
                    ...
                    .tag(BlazingTags.Items.FOODS.tag)
                    .properties(
                            p -> p.food(Foods.ENCHANTED_BLAZE_APPLE.foodProperties).rarity(Rarity.EPIC).fireResistant())
                    .onRegisterAfter(Registries.ITEM,
                                     v -> ItemDescription.useKey(v, "item.blazinghot.extinguishing_food"))
                    .register();
